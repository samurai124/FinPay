...
public class Main {
        ...
        do {
            ...
            if (choix == 1) {
                ...
                System.out.println("1- Gérer les prestataires\n" +
                        ...
                        "4- Retour");
                System.out.println("------------------------------------------------------");
                int c = ValidationDonnees.validateInts("votre choix : ");
                switch (c) {
                ...
                Prestataire pr = getPrestataireById(ValidationDonnees.validateInts(" l'id du prestataire : "));
                if (pr != null) {
                    System.out.println("------------------------------------------------------");
                ...
                Client client = getClientById(ValidationDonnees.validateInts(" l'id du client : "));
                if (client != null) {
    ...
    public static void fonctionsPrestataire() {
        ...
        do {
            ...
            c = ValidationDonnees.validateInts("votre choix : ");
            switch (c) {
