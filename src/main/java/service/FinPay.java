...
public class FinPay {
    ...
    public void modifierPrestataire() {
        ...
        Prestataire prestataire = DBconnection.getPreatataireDB().stream().filter(element -> element.getId() == id)
                .findAny().orElse(null);
        if (prestataire == null) {
    ...
    public void modifierClient() {
        ...
        Client client = DBconnection.getClientDB().stream().filter(element -> element.getId() == id).findAny()
                .orElse(null);
        if (client == null) {
